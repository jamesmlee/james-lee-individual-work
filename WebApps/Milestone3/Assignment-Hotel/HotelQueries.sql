...
SELECT Room_Reservation.ReservationID, Room_Reservation.Room_ReservationID, Room_Reservation.RoomID, Room_Reservation.CheckInDate, Room_Reservation.CheckOutDate
...
(
    ...
    HAVING COUNT(Room_Reservation.RoomID) >= 2) T2 
