...
/*
Change the title of Ghostbusters to Ghostbusters (1984) 
and the release date to 6/8/1984
*/
...
/*
above doesn't work; must delete cast members before movie
*/
...
/*
Alter the Actor table to add a column DateOfDeath. 
Set John Candy's record to be 3/4/1994.
*/
