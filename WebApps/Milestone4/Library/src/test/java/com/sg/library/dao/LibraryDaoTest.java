...
// create a publisher and an author, put them into DB.
// create a book; set author and publisher on to book. persist book into DAO    
    @Test
    ...
    public void deleteBook() {
        ...
        book.setPublishDate(LocalDate.parse("2010-01-01", DateTimeFormatter.ISO_DATE));
