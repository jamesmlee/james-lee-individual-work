            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <sf:form class="form-horizontal" role="form" modelAttribute="button"
                             action="displayCreateOrganizationPage" method="POST">                             
                                ...
                                <c:forEach 
                                    ...
                                    <tr> 
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/organization/displayUpdateOrganizationPage?organizationToUpdate=${currentOVM.organization.organizationId}">Edit</a><br/>
                                            <a href="${pageContext.request.contextPath}/organization/delete_organization?organizationToDelete=${currentOVM.organization.organizationId}">Delete</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
