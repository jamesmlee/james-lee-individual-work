...
public class SuperPersonSightingDaoDbImpl implements SuperPersonSightingDao {
    ...
    private static String SQL_INSERT_SUPERPERSON_SIGHTING
            = "INSERT INTO SuperPerson_Sighting (SuperPersonId, SightingId) VALUES (?, ?)";
    private static String SQL_GET_SUPERPERSON_SIGHTING
            = "SELECT * FROM SuperPerson_Sighting WHERE SuperPerson_SightingId = ?";
    private static String SQL_UPDATE_SUPERPERSON_SIGHTING
            = "UPDATE SuperPerson_Sighting SET name = ? WHERE SuperPerson_SightingId = ?";
    private static String SQL_DELETE_SUPERPERSON_SIGHTING
            = "DELETE FROM SuperPerson_Sighting WHERE SuperPerson_SightingId = ?";
    private static String SQL_LIST_SUPERPERSON_SIGHTINGS
            = "SELECT * FROM SuperPerson_Sighting LIMIT ?, ?";
    private static String SQL_GET_SUPERPERSONSIGHTING_BY_SUPERPERSON_AND_SIGHTING
            = "SELECT * FROM SuperPerson_Sighting WHERE SuperPersonId = ? AND SightingId = ?";
    ...
    public SuperPersonSighting getSuperPersonSightingBySuperPersonAndSighting(SuperPerson superPerson, Sighting sighting) {
        ...
        return jdbcTemplate.queryForObject(SQL_GET_SUPERPERSONSIGHTING_BY_SUPERPERSON_AND_SIGHTING, 
                new SuperPersonSightingDaoDbImpl.SuperPersonSightingMapper(), superPersonId, sightingId);
    }
