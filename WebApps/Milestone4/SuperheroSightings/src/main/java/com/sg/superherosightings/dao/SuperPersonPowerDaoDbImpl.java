...
public class SuperPersonPowerDaoDbImpl implements SuperPersonPowerDao {
    ...
    private static String SQL_INSERT_SUPERPERSON_POWER
            = "INSERT INTO SuperPerson_Power (SuperPersonId, PowerId) VALUES (?, ?)";
    private static String SQL_GET_SUPERPERSON_POWER
            = "SELECT * FROM SuperPerson_Power WHERE SuperPerson_PowerId = ?";
    ...
    private static String SQL_DELETE_SUPERPERSON_POWER
            = "DELETE FROM SuperPerson_Power WHERE SuperPerson_PowerId = ?";
    private static String SQL_LIST_SUPERPERSON_POWERS
            = "SELECT * FROM SuperPerson_Power LIMIT ?, ?";
    private static String SQL_GET_SUPERPERSONPOWER_BY_SUPERPERSON_AND_POWER
            = "SELECT * FROM SuperPerson_Power WHERE SuperPersonId = ? AND PowerId = ?";
