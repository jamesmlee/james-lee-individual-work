...
-- -----------------------------------------------------
-- Schema SuperSightings_queries
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `SuperSightings_queries` ;

-- -----------------------------------------------------
-- Schema SuperSightings_queries
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `SuperSightings_queries` DEFAULT CHARACTER SET utf8 ;
USE `SuperSightings_queries` ;

-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`Address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`Address` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`Address` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`Location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`Location` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`Location` (
  ...
  CONSTRAINT `fk_Location_Address`
    ...
    REFERENCES `SuperSightings_queries`.`Address` (`AddressId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`Sighting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`Sighting` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`Sighting` (
  ...
  CONSTRAINT `fk_Sighting_Location1`
    ...
    REFERENCES `SuperSightings_queries`.`Location` (`LocationId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`SuperPerson`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`SuperPerson` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`SuperPerson` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`Organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`Organization` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`Organization` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`Power`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`Power` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`Power` (
...
(5, 'Immaculate Taste');
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`SuperPerson_Organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`SuperPerson_Organization` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`SuperPerson_Organization` (
  ...
  CONSTRAINT `fk_SuperPerson_Organization_SuperPerson1`
    ...
    REFERENCES `SuperSightings_queries`.`SuperPerson` (`SuperPersonId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SuperPerson_Organization_Organization1`
    FOREIGN KEY (`OrganizationId`)
    REFERENCES `SuperSightings_queries`.`Organization` (`OrganizationId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`SuperPerson_Power`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`SuperPerson_Power` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`SuperPerson_Power` (
  ...
  CONSTRAINT `fk_SuperPerson_Power_Power1`
    FOREIGN KEY (`PowerId`)
    REFERENCES `SuperSightings_queries`.`Power` (`PowerId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
(10, 5, 5);
-- -----------------------------------------------------
-- Table `SuperSightings_queries`.`SuperPerson_Sighting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_queries`.`SuperPerson_Sighting` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_queries`.`SuperPerson_Sighting` (
  ...
  CONSTRAINT `fk_SuperPerson_Sighting_Sighting1`
    ...
    REFERENCES `SuperSightings_queries`.`Sighting` (`SightingId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
