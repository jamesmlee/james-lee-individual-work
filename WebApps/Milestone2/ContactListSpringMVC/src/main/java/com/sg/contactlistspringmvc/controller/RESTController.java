...
// endpoint that allows client to get a contact from system by id
// look at incoming url. grab path variable at slot {id}, convert to long, hand as param into method    
...
// endpoint that allows the client to create a new contact
...
// endpoint that allows the client to delete a contact from the system
...
// endpoint that allows the client to update an existing contact
...
// endpoint that allows the client to get all the contacts
