...
// private ... if you want UserIO, ask the View    
// UserIO is a member of ClassRosterView
    ...
    public int printMenuAndGetSelection() {
        ...
        // between 0 and 6 instead of 1-5 b/c Nick's IO implementation is exclusive            
        int menuSelection = io.readInt("Please select from the above choices", 0, 6);
