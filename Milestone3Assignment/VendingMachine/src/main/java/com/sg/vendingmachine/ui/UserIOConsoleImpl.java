...
// need while loop and try/catch to reprompt until they input $ to 2 decimals    
    @Override
    public BigDecimal readBigDecimal(String prompt) {
        ...
        while (!validInput) {
            ...
            try {
                ...
                print("ERROR: Please enter a valid dollar amount in format X.XX");
            }
        }
        return bigDecimal;
    }
...
/*
        if(bigDecimal.scale() > 2) {
            print("Invalid input. Input must have 2 or less decimal places");
        }
*/
/*
        String bigDecimalInput = readString(prompt);
        BigDecimal bigDecimal = new BigDecimal(bigDecimalInput);
        bigDecimal = bigDecimal.setScale(2, RoundingMode.HALF_UP);
        return bigDecimal;
*/